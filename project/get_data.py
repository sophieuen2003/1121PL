...
# url
id = 5128143  # 目前作業id，初始值為21286最新一筆
url_init = 'article/'+str(id)
url_h = 'https://www.cw.com.tw/'
# https://www.cw.com.tw/article/5128144
...
for i in range(1):
    ...
    # 找class='_2E8y'的文章
    article_idv=sp.select('.article__content')
